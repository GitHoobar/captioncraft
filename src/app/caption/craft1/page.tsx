...
export default function Craft(){
    ...
    const fetchTranscript = async () => {
        try {
            const response = await axios.post('/api/whisperai/transcript', { url: Videourl });
        ...
        <div className="flex flex-col gap-12 ]">
            <div className="flex justify-center items-center mt-16 gap-4">
                ...
                <div className="flex justify-center items-center">
                    <button
                        onClick={() => { previewButton(); buttonClick(); }}
            ...
            <div className="w-[83%] mx-auto flex justify-center items-center"><div className="relative w-[100%] h-72 xl:h-[70vh] lg:h-[70vh] md:h-[60vh] border border-white bg-[#5E5E5E]"></div>
                {Videourl && (
            ...
            <div className="flex justify-center items-center">
                <button onClick={fetchTranscript} className="minecraft-btn h-8 w-32 text-center text-white text-[0.5rem] truncate p-2 border-2 border-b-4 hover:text-yellow-200">
                    Generate Transcript
                </button>
            </div>
            {transcript && (
            ...
            <div className="flex justify-center h-[40vh] w-[100%] xl:h-[120vh] lg:h-[90vh] lg:w-[98%] md:h-[80vh] md:w-[100vw] sm:h-[50vh] sm:w-[80vh] items-center ">
                <img src="/images/transcript.png" alt="Transcript" className="size-[80%]  xl:size-[80%] lg:size-[70%] md:size-[70%] sm:size-[70%]" />
            </div>
        </div>
        </div>
        </>
